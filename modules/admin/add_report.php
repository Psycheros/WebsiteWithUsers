...
<div>
    <input class="submenu-toggle" type="checkbox" id = "addreport-drawer-toggle" name="editcase-drawer-toggle">
    <label for="addreport-drawer-toggle" id="addreport-drawer-toggle-label">Click Here to Add Report</label>
